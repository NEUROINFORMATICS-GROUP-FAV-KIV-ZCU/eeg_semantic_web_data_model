...
Následující vytvářená sémantická část modelu bude prová-\\dět transformaci původního relačního modelu, z jehož tabulek nesoucích zmíněné datové soubory jsou ty atributy odstraněny (z důvodu jejich přesunu do této nové relační části modelu).
